...
public class ProjectMemberDialogFragment extends DialogFragment {
	private IWXAPI api;
	private QQShare mQQShare = null;
	public static QQAuth mQQAuth;
	
	public static ProjectMemberDialogFragment newInstance(Bundle args) {
    	ProjectMemberDialogFragment f = new ProjectMemberDialogFragment();
        f.setArguments(args);
        return f;
    }
...
//		final Event event = Event.load(Event.class, modelId);
    	...
    	final Event event = Event.load(Event.class, bundle.getLong("PROJECT_ID"));
...
//    	});
    	v.findViewById(R.id.EventMemberDialogFragment_invite_qq).setOnClickListener(new OnClickListener(){
			...
			public void onClick(View v) {
				...
				((HyjActivity)getActivity()).openActivityWithFragment(InviteMemberFormFragment.class, R.string.inviteMemberFormFragment_send_title, bundle);
				dismiss();
